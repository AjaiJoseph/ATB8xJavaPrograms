...
public class Lab160_String_Equals {
    public static void main(String[] args) {
        ...
        String s4 = "Hello"; // SCP - String constant pool
        String s2 = new String("Hello"); // Object Area
        String s3 = new String("Hello"); // Object Area
        String s5 = new String("hello"); // Object Area

//        System.out.println(s1 == s2); // false ( Becas both are in different locations
//        System.out.println(s2 == s3);// false
//        System.out.println(s1 == s4); // Ture (Becas its already presented in SCP- String constant pool
